...
const Card = (props) => {
  ...
  return (
    <div className="card mx-4" style={{ width: "400px", display: "inline-block" }}>
      <img className="card-img-top" width="600px" height="200px" src={store.images[entity.type + entity.uid] || "https://mpudata.sfo2.digitaloceanspaces.com/original/2X/6/6f7d37cd5f7ef08a2a17602e0aa6ad3a6880d747.jpeg"} alt="Card image cap" />
